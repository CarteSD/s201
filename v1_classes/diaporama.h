...
class Diaporama {
    ...
    public :
        Diaporama(string pTitre = "Sans titre",
        ...
        void vitesseDefilement(unsigned int pVitesse = 2);
        ...
        void chargerImages(vector <unsigned int> pTab, unsigned int pTailleTab);
