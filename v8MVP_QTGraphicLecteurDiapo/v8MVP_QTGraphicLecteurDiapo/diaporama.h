...
class Diaporama {
    ...
    public :
        ...
        void chargerImages(vector<vector<unsigned int>> pTab, unsigned int pTailleTab, vector <Image*> pAllImages);
